...
import { type Action, isStandardActionId } from "#/model/definition/action.ts"
import type { ErrorType } from "#/model/definition/error.ts"
import {
  type ModelCatalog,
...
import { type Query, type CustomQuery } from "#/model/definition/query.ts"
