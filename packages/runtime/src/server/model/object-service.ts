...
import type { ModelCatalog, ObjectType } from "#/model/index.ts"
import { ROOT_ID } from "#/model/system-records.ts"
import { compileAssetReferences } from "#/server/assets/references.ts"
...
import type { ModelObjectService } from "#/server/model-implementation.ts"
