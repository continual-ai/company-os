...
Bind hosted implementations in `apps/api/src/composition-root.ts`. Keep Continual API or SDK types
inside the adapter. Company services consume semantic company-owned contracts.
