...
app only through `company-os/model`, `company-os/client`, `company-os/config`, `company-os/ui/*`,
and `company-os/styles.css`; never from another satellite. Call the central app from server code
