...
function resolveObject() {
  return routeObjectAtPath(presentation, "/settings/modules")
}

export const Route = createFileRoute("/_app/settings/modules/$recordId")({
...
function RecordPage() {
  ...
  return (
    <ModelRecordPage
      key={params.recordId}
      object={routeObjectAtPath(runtime, "/settings/modules")}
