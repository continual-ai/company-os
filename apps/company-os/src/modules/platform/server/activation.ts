...
import {
  ...
  requiredModuleIds,
} from "#/modules/platform/model/index.ts"
...
export const readModuleCatalog = Effect.fn("platform.readModuleCatalog")(
  function* () {
...
export const moduleCatalog = Effect.fn("platform.moduleCatalog")(function* () {
  yield* (yield* Authorization).require({
    objectType: ModuleSetting.id,
    operationId: "catalog",
  })
