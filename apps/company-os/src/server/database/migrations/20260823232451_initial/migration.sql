...
CREATE TABLE "objects" (
	...
	CONSTRAINT "objects_object_type_check" CHECK ("object_type" in ('platform', 'company', 'contact', 'lead', 'deal', 'lineItem', 'interaction')),
...
ALTER TABLE "companies" ADD CONSTRAINT "companies_platform_id_roots_id_fkey" FOREIGN KEY ("platform_id") REFERENCES "roots"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "contacts" ADD CONSTRAINT "contacts_platform_id_roots_id_fkey" FOREIGN KEY ("platform_id") REFERENCES "roots"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "deals" ADD CONSTRAINT "deals_platform_id_roots_id_fkey" FOREIGN KEY ("platform_id") REFERENCES "roots"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "interactions" ADD CONSTRAINT "interactions_platform_id_roots_id_fkey" FOREIGN KEY ("platform_id") REFERENCES "roots"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "leads" ADD CONSTRAINT "leads_platform_id_roots_id_fkey" FOREIGN KEY ("platform_id") REFERENCES "roots"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "record_aliases" ADD CONSTRAINT "record_aliases_object_id_objects_id_fkey" FOREIGN KEY ("object_id") REFERENCES "objects"("id") ON DELETE CASCADE;