...
CREATE TABLE "objects" (
	...
	CONSTRAINT "objects_kind_check" CHECK ("kind" in ('root', 'company', 'contact', 'deal', 'lead', 'interaction')),
...
ALTER TABLE "interactions" ADD CONSTRAINT "interactions_subject_id_parties_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "parties"("id") ON DELETE RESTRICT;--> statement-breakpoint
...
ALTER TABLE "parties" ADD CONSTRAINT "parties_id_objects_id_fkey" FOREIGN KEY ("id") REFERENCES "objects"("id") ON DELETE CASCADE;--> statement-breakpoint
