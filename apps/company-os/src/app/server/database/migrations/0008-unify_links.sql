-- Pre-release ontology reset: existing business data is intentionally discarded.
-- Keep applied migration history; rebuild model and infrastructure under the unified Link contract.
drop table if exists "objects", "roots", "record_aliases", "interface_actor", "interface_identity", "interface_note_subject", "interface_party", "users", "service_accounts", "anonymous_actors", "assets", "module_settings", "notes", "activities", "companies", "contacts", "leads", "deals", "line_items", "campaigns", "contents", "enrollments", "outreaches", "issues", "projects", "repositories", "pull_requests", "job_postings", "candidates", "applications", "tickets", "replies", "escalations", "note_subjects", "contact_companies", "contact_primary_company", "deal_companies", "issue_pull_requests", "ticket_issues", "identity_bindings", "asset_blobs", "asset_references", "event_journal_state", "event_journal", "record_search", "search_index_state", "seed_runs" cascade;
drop function if exists "reject_event_journal_mutation"() cascade;
