import { ComponentExample } from "#/app/ui/developer/design-system/component-example.tsx"
import { getComponentExample } from "#/app/ui/developer/design-system/component-examples.tsx"
import type { ComponentSlug } from "#/app/ui/developer/design-system/component-metadata.ts"
import { getComponent } from "#/app/ui/developer/design-system/component-metadata.ts"
        ...
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-xs leading-5 text-muted-foreground">
            ...
            <code className="bg-muted px-1.5 py-0.5">
              @company/runtime/ui/{component.slug}
            </code>
