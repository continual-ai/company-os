...
import type { ComponentSlug } from "#/app/ui/developer/design-system/component-metadata.ts"
import {
  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
} from "#/runtime/ui/components/accordion.tsx"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import {
  ...
  AlertDescription,
  AlertTitle,
} from "#/runtime/ui/components/alert.tsx"
import {
  Attachment,
  AttachmentAction,
  AttachmentActions,
  ...
  AttachmentMedia,
  AttachmentTitle,
} from "#/runtime/ui/components/attachment.tsx"
import {
  Avatar,
  AvatarBadge,
  AvatarFallback,
  AvatarGroup,
  AvatarGroupCount,
} from "#/runtime/ui/components/avatar.tsx"
...
import { Bubble, BubbleContent } from "#/runtime/ui/components/bubble.tsx"
...
import {
  ...
  ChartTooltipContent,
  type ChartConfig,
} from "#/runtime/ui/components/chart.tsx"
import { ChatShell, type ChatMessage } from "#/runtime/ui/components/chat.tsx"
...
import {
  ...
  InputGroupInput,
  InputGroupText,
} from "#/runtime/ui/components/input-group.tsx"
import { Input } from "#/runtime/ui/components/input.tsx"
import { Label } from "#/runtime/ui/components/label.tsx"
import {
  Marker,
  MarkerContent,
  MarkerIcon,
} from "#/runtime/ui/components/marker.tsx"
import {
  MessageScroller,
...
} from "#/runtime/ui/components/message-scroller.tsx"
import {
  Message,
  MessageAvatar,
  MessageContent,
  MessageHeader,
} from "#/runtime/ui/components/message.tsx"
...
import {
  ...
  ProgressLabel,
  ProgressValue,
} from "#/runtime/ui/components/progress.tsx"
import {
  RadioGroup,
  RadioGroupItem,
} from "#/runtime/ui/components/radio-group.tsx"
import {
  Select,
  SelectContent,
  SelectGroup,
...
import { Separator } from "#/runtime/ui/components/separator.tsx"
import {
  Sheet,
  SheetContent,
  SheetDescription,
  ...
  SheetTitle,
  SheetTrigger,
} from "#/runtime/ui/components/sheet.tsx"
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
import { Spinner } from "#/runtime/ui/components/spinner.tsx"
import { Switch } from "#/runtime/ui/components/switch.tsx"
import {
  Table,
  TableBody,
  TableCell,
...
import { toast, Toaster } from "#/runtime/ui/components/toast.tsx"
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
} from "#/runtime/ui/components/tooltip.tsx"
...
const exampleDetails = {
  accordion: {
    code: snippet(
      'import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "#/runtime/ui/components/accordion.tsx"',
      "",
  ...
  alert: {
    code: snippet(
      'import { Alert, AlertDescription, AlertTitle } from "#/runtime/ui/components/alert.tsx"',
      "",
      "<Alert>",
      "  <CheckCircle2Icon />",
  ...
  "alert-dialog": {
    code: snippet(
      'import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "#/runtime/ui/components/alert-dialog.tsx"',
      "",
      "<AlertDialog>",
  ...
  attachment: {
    code: snippet(
      'import { Attachment, AttachmentContent, AttachmentMedia, AttachmentTitle } from "#/runtime/ui/components/attachment.tsx"',
      "",
  ...
  avatar: {
    code: snippet(
      'import { Avatar, AvatarBadge, AvatarFallback } from "#/runtime/ui/components/avatar.tsx"',
      "",
      '<Avatar size="lg">',
  ...
  breadcrumb: {
    code: snippet(
      'import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator } from "#/runtime/ui/components/breadcrumb.tsx"',
      "",
      "<Breadcrumb>",
      "  <BreadcrumbList>",
  ...
  card: {
    code: snippet(
      'import { Card, CardAction, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "#/runtime/ui/components/card.tsx"',
      "",
      "<Card>",
      "  <CardHeader>",
  ...
  chart: {
    code: snippet(
      'import { ChartContainer, ChartTooltip, ChartTooltipContent } from "#/runtime/ui/components/chart.tsx"',
  ...
  chat: {
    code: snippet(
      'import { ChatShell } from "#/runtime/ui/components/chat.tsx"',
      "",
      "<ChatShell",
      "  messages={messages}",
      "  value={draft}",
  ...
  command: {
    code: snippet(
      'import { Command, CommandGroup, CommandInput, CommandItem, CommandList } from "#/runtime/ui/components/command.tsx"',
      "",
      "<Command>",
  ...
  dialog: {
    code: snippet(
      'import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, DialogTrigger } from "#/runtime/ui/components/dialog.tsx"',
      "",
      "<Dialog>",
  ...
  "dropdown-menu": {
    code: snippet(
      'import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger } from "#/runtime/ui/components/dropdown-menu.tsx"',
      "",
      "<DropdownMenu>",
  ...
  empty: {
    code: snippet(
      'import { Empty, EmptyContent, EmptyDescription, EmptyHeader, EmptyMedia, EmptyTitle } from "#/runtime/ui/components/empty.tsx"',
      "",
      "<Empty>",
  ...
  field: {
    code: snippet(
      'import { Field, FieldDescription, FieldLabel } from "#/runtime/ui/components/field.tsx"',
      'import { Input } from "#/runtime/ui/components/input.tsx"',
      "",
      "<Field>",
  ...
  "input-group": {
    code: snippet(
      'import { InputGroup, InputGroupAddon, InputGroupInput, InputGroupText } from "#/runtime/ui/components/input-group.tsx"',
      "",
      "<InputGroup>",
  ...
  marker: {
    code: snippet(
      'import { Marker, MarkerContent, MarkerIcon } from "#/runtime/ui/components/marker.tsx"',
      "",
  ...
  message: {
    code: snippet(
      'import { Message, MessageAvatar, MessageContent, MessageHeader } from "#/runtime/ui/components/message.tsx"',
      "",
      "<Message>",
  ...
  "message-scroller": {
    code: snippet(
      'import { MessageScroller, MessageScrollerButton, MessageScrollerContent, MessageScrollerItem, MessageScrollerProvider, MessageScrollerViewport } from "#/runtime/ui/components/message-scroller.tsx"',
      "",
      "<MessageScrollerProvider>",
      "  <MessageScroller>",
      "    <MessageScrollerViewport>",
  ...
  popover: {
    code: snippet(
      'import { Popover, PopoverContent, PopoverDescription, PopoverHeader, PopoverTitle, PopoverTrigger } from "#/runtime/ui/components/popover.tsx"',
      "",
      "<Popover>",
  ...
  progress: {
    code: snippet(
      'import { Progress, ProgressLabel, ProgressValue } from "#/runtime/ui/components/progress.tsx"',
      "",
      "<Progress value={68}>",
  ...
  "radio-group": {
    code: snippet(
      'import { RadioGroup, RadioGroupItem } from "#/runtime/ui/components/radio-group.tsx"',
      'import { Label } from "#/runtime/ui/components/label.tsx"',
      "",
  ...
  select: {
    code: snippet(
      'import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "#/runtime/ui/components/select.tsx"',
      "",
  ...
  sheet: {
    code: snippet(
      'import { Sheet, SheetContent, SheetDescription, SheetFooter, SheetHeader, SheetTitle, SheetTrigger } from "#/runtime/ui/components/sheet.tsx"',
      "",
      "<Sheet>",
  ...
  sidebar: {
    code: snippet(
      'import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarProvider } from "#/runtime/ui/components/sidebar.tsx"',
      "",
      "<SidebarProvider>",
  ...
  table: {
    code: snippet(
      'import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "#/runtime/ui/components/table.tsx"',
      "",
      "<Table>",
  ...
  tabs: {
    code: snippet(
      'import { Tabs, TabsContent, TabsList, TabsTrigger } from "#/runtime/ui/components/tabs.tsx"',
      "",
  ...
  tooltip: {
    code: snippet(
      'import { Tooltip, TooltipContent, TooltipTrigger } from "#/runtime/ui/components/tooltip.tsx"',
      "",
      "<Tooltip>",
