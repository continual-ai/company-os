...
The Console is a static operating-model shell, and the server exposes health and contract
description routes. Authentication, persistence, actions, and Effect services are the next
implementation work.
