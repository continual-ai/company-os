...
Acme's public website, built with TanStack Start.

This app explains the company and routes people into the customer portal or internal Company OS.
It owns public content and presentation, not business records or operating policy.

## Boundaries

- Reuse company-owned components and tokens from `@acme/ui`.
- Access Company OS capabilities through public, typed interfaces when a real use case requires it.
